...
public class InsertServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // DAOクラスの商品情報追加メソッドにフォームから送信された情報を渡す
        int result = product.Insert(request.getParameter("productName"));
        
        // 更新結果があればその数値をセッションに格納
        if(result > 0) {
            session.setAttribute("InsertResult", result);
        }
