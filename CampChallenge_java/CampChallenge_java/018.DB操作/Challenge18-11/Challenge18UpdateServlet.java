 ...
 * @author guest1Day
 */
public class Challenge18UpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // UPDATE処理のSQL
        String delete = "UPDATE profiles SET name = ?, tel = ?, age = ?, "
        ...
        try (PrintWriter out = response.getWriter();
            ...
            pstmt.setInt(5, Integer.parseInt(request.getParameter("UpdateID")));
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Challenge18UpdateServlet</title>");            
            out.println("</head>");
            out.println("<body>");
